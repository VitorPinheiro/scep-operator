...
nohup java -jar scep-operator-op1-v1.jar &
printf "Operator 1 is up, loading operator 2...\n"
nohup java -jar scep-operator-op2-v1.jar &
printf "Operator 2 is up, loading operator 3...\n"
nohup java -jar scep-operator-op3-v1.jar &
printf "Operator 3 is up, loading operator 4...\n"
nohup java -jar scep-operator-op4-v1.jar &
printf "Operator 4 is up, loading operator 5...\n"
nohup java -jar scep-operator-op5-v1.jar &
printf "Operator 5 is up, loading operator 6...\n"
nohup java -jar scep-operator-op6-v1.jar &
