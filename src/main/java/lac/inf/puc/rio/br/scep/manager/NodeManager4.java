...
public class NodeManager4 
{
	...
	private static Logger logger = LogManager.getLogger(NodeManager4.class);
    ...
    public static void main( String[] args )
    {
    	...
    	_nodeID = Integer.valueOf(_utils.getProperty("node4.properties","id"));
